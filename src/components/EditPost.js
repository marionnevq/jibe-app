...
const EditPost = ({handleClose, post}) => {
    ...
    const handleSaveChanges = () => {
        ...
        const imageRef = ref(
          storage,
          `images/${post.userUsername}_${post.postID}`
        );
    ...
    <Box className='edit-form' sx={{ ...style, width: "80%",height: "auto", borderRadius: "15px"}}>
          ...
          <Grid container sx={{width: "100%", display: "flex", justifyContent: "center"}}>
             <Grid item xs={12} md={12} sx={{width: "100%", display: "flex", justifyContent: "center"}}>
              ...
              <Grid item xs={12} md={12} sx={{width: "100%", display: "flex", justifyContent: "center"}}>
                <img src={imageUrl === null? post.imageUrl : imageUrl} style={{width: "60%"}}/>
              </Grid>
              <Grid item xs={12} md={12} sx={{width: "100%", display: "flex", justifyContent: "center"}}>
              <Button
                variant="contained"
            ...
            >
              ...
              <Grid item xs={12} md={12} sx={{width: "100%", display: "flex", justifyContent: "center"}}>
                <Button variant='contained' onClick={handleSaveChanges} sx={{fontFamily: "montserrat", fontSize: "15px", borderRadius: "35px"}}>Save Changes</Button>
              </Grid>
          </Grid>
    </Box>
