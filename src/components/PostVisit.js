    ...
    >
      ...
      >
        <Box className="info" sx={{ p: 0.2 }}>
          ...
          <Box className="opName" sx={{ p: 1, color: (() => theme === "light" ? "#333333" : "white") }}>
            <span>Mark Lee</span>
        ...
        <Box className="postContent" sx={{ p: 0.2, color: (() => theme === "light" ? "#333333" : "white") }}>
        ...
        <Divider />
        <Box className="reactions" sx={{ p: 0.2, color: (() => theme === "light" ? "#333333" : "white")}}>
