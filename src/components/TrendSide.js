...
const TrendSide = () => {
  ...
  return (
    ...
    <Grid container sx={{display: "flex", justifyContent: "center", alignItems: "center"}}>
        <Paper className='trends' sx={{width: "90%", height: "330px", paddingBottom: "10px", borderRadius:"0.6rem", boxShadow:"2"}}>
          ...
          <Grid container item className="latchBox" sx={{ width: "90%", height:"230px" }}>
            <Box className="latchList"  sx={{ width: "100%", height:"200px" , p: 0.5,  borderRadius:"0.6rem" , display: "flex", flexDirection: "column" }}>
              {users && users.map((user) => (
              <Box className="latchInfo" sx={{ width: "100%", height:"47px",  display: "flex", marginTop: "5px" , marginBottom: "5px" }}>
                <Box className="latchDp" sx={{ width: "20%", display: "flex", justifyContent: "center", alignItems: "center" }}>
                  <img src={user.imageUrl}/>
                </Box>
                <Box className="latchName" sx={{ width: "75%", cursor: "pointer"  }} onClick={() => {GoToProfile (user)}}>
